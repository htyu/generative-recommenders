...
def _get_fw_configs() -> List[triton.Config]:  # noqa: C901
    ...
    if torch.version.hip:
        ...
        configs = [
            ...
            # triton.Config(
            #     {"BLOCK_M": 128, "BLOCK_N": 32, "USE_TLX": False, 'NUM_BUFFERS': 4, 'NUM_MMA_WARPS_PER_GROUP': 4, 'NUM_MMA_GROUPS': 2},
            #     num_stages=4,
            #     num_warps=8,
            #     pre_hook=_host_descriptor_pre_hook,
            # ),
...
def _hstu_attn_fwd_compute_tlx(  # noqa C901
    ...
    # allocate buffers
    q_tiles = tlx.local_alloc((BLOCK_M_SPLIT, BLOCK_D_Q), tlx.dtype_of(Q), NUM_MMA_GROUPS)
